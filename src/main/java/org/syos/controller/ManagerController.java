...
public class ManagerController {
    ...
    public void displayShelfStock() {
        System.out.println("\nShelf stock display - would query ShelfStockRepository");
    }
    ...
    public void displayDailySalesReport(String date) {
        try {
            ...
            ReportAppService.DailySalesReport report = 
                reportService.generateDailySalesReport(reportDate, null);
    ...
    public void displayCounterSalesReport(String date) {
        try {
            LocalDate reportDate = date != null ? LocalDate.parse(date) : LocalDate.now();
            ReportAppService.DailySalesReport report = 
                reportService.generateDailySalesReport(reportDate, TransactionType.COUNTER);
    ...
    public void displayOnlineSalesReport(String date) {
        try {
            LocalDate reportDate = date != null ? LocalDate.parse(date) : LocalDate.now();
            ReportAppService.DailySalesReport report = 
                reportService.generateDailySalesReport(reportDate, TransactionType.ONLINE);
    ...
    private void printDailySalesReport(ReportAppService.DailySalesReport report) {
        ...
        System.out.println("Transaction Type: " + 
            (report.getTransactionType() != null ? 
             report.getTransactionType().getDisplayName() : "All"));
